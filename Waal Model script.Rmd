...
Steps 1-4 above are then repeated, this time using the brooding data subset. 
...
Step 3: The categorical boldness variable is created and set aside for later. 
```{r brood-pers-cat, message=FALSE, warning=FALSE, echo=TRUE}

```

Step 4: the new variable representing partner's previous trip is created.
...
An updated, combined data set of both the incubation and brooding data is created for use later (visualisation)'
