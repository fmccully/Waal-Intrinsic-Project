...
in_coeff
nest_ml_dfin<- as.data.frame(in_coeff)
write.csv(nest_ml_dfin, file = "incubation_models.csv")
...
br_coeff
nest_ml_df<- as.data.frame(br_coeff)
write.csv(nest_ml_df, file = "brooding_models.csv")
