...
## @knitr setup2
#setup
setwd("M:/Documents/R Practice/Wandering albatross/Model R Markdown/Waal-Intrinsic-Project/Anon Files")
library(dplyr)
library(MuMIn)
library(ggplot2)
library(lme4)
...
total_df2<-read.csv("anon_waal_dataset.csv")
...
# scale new variable and summary
incu_new2$ppb_ave_diff_sc<-scale(incu_new2$ppb_ave_diff) 
...
# # scale new variable and summary
brood_new2$ppb_ave_diff_sc<-scale(brood_new2$ppb_ave_diff) 
